"""
Shared playbook seed data — used by Postgres and Qdrant seed scripts.
"""
...
PLAYBOOKS = [
    {
        "id": "pb-nda-001",
        "name": "NDA Standards",
        "description": "Standard mutual NDA clauses for vendor and partner agreements.",
        "contract_type": "NDA",
        "clauses": NDA_CLAUSES,
    },
    {
        "id": "pb-msa-001",
        "name": "MSA Standards",
        "description": "Master services agreement playbook for enterprise vendor contracts.",
        "contract_type": "MSA",
        "clauses": MSA_CLAUSES,
    },
    {
        "id": "pb-sla-001",
        "name": "SLA Standards",
        "description": "Service level agreement standards for SaaS and infrastructure vendors.",
        "contract_type": "SLA",
        "clauses": SLA_CLAUSES,
    },
]
